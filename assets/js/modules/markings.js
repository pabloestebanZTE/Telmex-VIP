$(function () {
    var ini = {
        ...
        events: function () {
            ...
            $('.addPrincipalCode').on('click', ini.addPrincipalCode);
            $('#btnPrincipal').on('click', ini.removePrincipalCode);
        ...
        addPrincipalCode: function () {
            var html = '<div style="margin-left: 186px; width: 100%;" id="group'+ ini.countPrincipal +'">'
                            + '<div class="col-sm-8 seccionPrincipal">'
                                + '<input type="text" class="form-control" id="nombre_empresa" placeholder="Principal" style="margin-top: 10px;">'
                            + '</div>'
                            + '<div class="col-sm-2 seccionPrincipal">'
                                + '<button type="button" class="btn btn-success addPrincipalCode" id="addPrincipalCode" style="margin: 10px 5px 0px 0px;">+</button>'
                                + '<button type="button" class="btn btn-danger" id="removePrincipalCode" style="margin-top: 10px;">-</button>'
                            + '</div>'
                        + '</div>';
            ini.countPrincipal++;
